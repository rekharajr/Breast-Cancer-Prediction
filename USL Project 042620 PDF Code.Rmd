...
```{r}
table(biopsy.km$cluster, biopsy.hclust2.clusters)

```
>Using table(), compare cluster membership between the two clustering methods. The different components of k-means model objects were accessed with the $ operator.
